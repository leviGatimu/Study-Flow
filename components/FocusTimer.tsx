          ...
          <div className="flex items-baseline font-heading font-black tabular-nums tracking-tighter">
            <AnimatePresence mode="popLayout">
              <motion.span 
                ...
                className="text-7xl sm:text-9xl text-foreground"
              >
                {timeLeft.h.toString().padStart(2, '0')}
              </motion.span>
            </AnimatePresence>
            <span className="text-5xl sm:text-7xl text-primary animate-pulse mx-1">:</span>
            <AnimatePresence mode="popLayout">
              <motion.span 
                key={timeLeft.m}
                initial={{ opacity: 0, y: 10 }}
            ...
            <AnimatePresence mode="popLayout">
              <motion.span 
                ...
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-4xl sm:text-6xl text-muted-foreground ml-1"
              >
