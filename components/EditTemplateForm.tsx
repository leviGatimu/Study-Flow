...
export function EditTemplateForm({ template }: { template: TemplateType }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full hover:bg-primary/10 hover:text-primary transition-all active:scale-90">
        ...
        <div className="bg-card">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            <div className="space-y-3">
              ...
              <Input 
                required 
                className="h-14 rounded-2xl bg-muted/30 border-border/60 focus:ring-primary/20 text-lg font-bold px-5" 
