...
import { 
  FileText, BrainCircuit, Plus, Send, 
      ...
      <div className="w-80 border-r bg-muted/20 flex flex-col shrink-0">
        ...
        <div className="p-4 flex-1 overflow-y-auto space-y-1">
          <div className="flex items-center justify-between px-2 mb-4">
             ...
             <Button variant="ghost" size="icon" className="h-6 w-6 rounded-lg" onClick={handleCreateDoc}>
          ...
          {project.docs.map(doc => (
            ...
            >
              ...
              <Trash2 
                ...
                onClick={async (e) => {
                  e.stopPropagation();
                  if (confirm('Delete document?')) await deleteProjectDoc(doc.id, project.id);
                }}
              />
            </button>
          ))}
              ...
              <div className="p-8 border-b flex items-center justify-between">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     ...
                     <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Gemini 2.5 Flash</p>
                   </div>
                 </div>
                 <Button variant="ghost" size="icon" className="rounded-full" onClick={() => setIsAiOpen(false)}>
