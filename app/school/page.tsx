...
export default async function SchoolPage() {
  ...
  // Access Control: Only "Levi" can see this page
  if (user?.username.toLowerCase() !== 'levi') {
    return (
    ...
    <div className="space-y-12 max-w-[1600px] mx-auto animate-in fade-in duration-500 pb-16">
      <div className="pt-6 pb-2 border-b border-border/40 flex items-center justify-between">
        <div>
          ...
          <p className="text-xl text-muted-foreground font-semibold mt-3">Live timetable and lesson tracking for Levi.</p>
        </div>
